...
<body>
  ...
  >
       ...
       <a href="{{url('success-pay')}}" style="text-decoration: none;background-color: green;color: #fff;border-radius: 10px;font-size: 18px;padding: 5px 10px;margin:20px">پرداخت موفق</a>
  </div>
</body>
</html>