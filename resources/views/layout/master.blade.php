...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav style="z-index: 1" class="main-header navbar navbar-expand bg-success navbar-light border-bottom">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <div style="direction: rtl">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="{{url('panel/services')}}" class="nav-link @yield('services')">
  ...
  <footer class="main-footer">
    <strong> طراحی و توسعه<a href="http://it-dev.ir"> تیم it-dev </a>.</strong>
  </footer>
