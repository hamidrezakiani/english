...
@section('content')
   ...
   <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{url('panel/readings')}}" method="POST">
        @csrf
  ...
  <div class="modal fade" id="reading-delete-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <div class="row">
      <form class="col-6" id="form-edit-title" action="{{url('panel/reading-tests/'.$test->id)}}" method="POST" style="display: none">
          @csrf
          <div class="form-group">
   ...
   @foreach ($test->readings as $reading)
      ...
      @foreach ($reading->questions as $item)
          ...
          <div class="col-12 bg-white form-translate-box" data-id="{{$item->id}}" style="text-align:left;display:none">
             <form action="{{url('panel/questions/'.$item->id)}}" style="direction: rtl" method="POST">
              @csrf
              <div class="form-group">
